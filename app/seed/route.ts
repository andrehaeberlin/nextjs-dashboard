...
export async function GET() {
  try {
    await sql.begin((sql) => [
      seedUsers(sql), // Passando sql como argumento
      seedCustomers(sql), // Passando sql como argumento
      seedInvoices(sql), // Passando sql como argumento
      seedRevenue(sql), // Passando sql como argumento
    ]);
